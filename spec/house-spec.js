...
describe('methods', function () {
  describe('#toString', function () {
    ...
    xit('returns a string with correct pluralization for multiple doors and 1 window', function () {
      var house = new House(3,1);
      expect(house.toString()).toEqual('The house has 3 doors and 1 window');
    });

    xit('returns a string with correct pluralization for multiple doors and multiple windows', function () {
      var house = new House(3,5);
      expect(house.toString()).toEqual('The house has 3 doors and 5 windows');
    });

    xit('returns a string with correct pluralization for 1 door and multiple windows', function () {
      var house = new House(1,65);
      expect(house.toString()).toEqual('The house has 1 door and 65 windows');
    });

    xit('returns a string with correct pluralization for 1 door and 1 window', function () {
      var house = new House(1,1);
      expect(house.toString()).toEqual('The house has 1 door and 1 window');
    });

    xit('returns a string with correct pluralization for 0 doors and 0 windows', function () {
